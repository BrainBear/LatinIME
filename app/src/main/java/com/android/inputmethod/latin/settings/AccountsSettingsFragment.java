...
public final class AccountsSettingsFragment extends SubScreenFragment {
     ...
     */
    private final OnPreferenceClickListener mSyncNowListener =
            new SyncNowListener();
    /**
     * Onclick listener for delete sync pref.
     */
    private final OnPreferenceClickListener mDeleteSyncDataListener =
            new DeleteSyncDataListener();

    /**
     * Onclick listener for enable sync pref.
     */
    private final OnPreferenceClickListener mEnableSyncClickListener =
     ...
     */
    class SyncNowListener implements OnPreferenceClickListener {
        @Override
        public boolean onPreferenceClick(final Preference preference) {
     ...
     */
    class DeleteSyncDataListener implements OnPreferenceClickListener {
        @Override
        public boolean onPreferenceClick(final Preference preference) {
     ...
     */
    class EnableSyncClickListener implements OnShowListener, OnPreferenceClickListener {
